...
public class ReactCanalController {
    ...
    public String envoyerTwilio(@PathVariable Long fieldId,@PathVariable double data ,HttpServletRequest request) {
        HttpHeaders headers = new HttpHeaders();
        headers.add("Authorization", request.getHeader("Authorization"));
        headers.add("content-type","application/json");

        ResponseEntity<List<React>> response = restTemplate.exchange(
                "http://localhost:8093/ReactField/"+fieldId,
                HttpMethod.GET,
    ...
    public  String envoyerHttp(@PathVariable Long fieldId,@PathVariable double data ,HttpServletRequest request){
        HttpHeaders headers = new HttpHeaders();
        headers.add("Authorization", request.getHeader("Authorization"));
        headers.add("content-type","application/json");
    ...
    public String envoyerEmailTriger(@PathVariable Long fieldId,@PathVariable double data ,HttpServletRequest request){
